...
export default function HomePage() {
    ...
    return <>
        <Nav />
        <SubNav />
        <main className="bg-backdrop w-full h-[80vh] grid grid-cols-[repeat(3,minmax(0,310px))] gap-4 p-5">
...
function TaskSection({ header, tasks }: { header: string, tasks: Task[] }) {
    ...
    return <section>
        ...
        <div className="bg-taskcard flex flex-col h-[60vh] p-2 rounded-sm">
